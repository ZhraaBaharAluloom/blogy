...
const handleSignup = async () => {
  const userCredentials = {
    ...
    fullName: fullNameValue.value.trim(),
    profileImg: profileImgValue.value.trim(),
  };
